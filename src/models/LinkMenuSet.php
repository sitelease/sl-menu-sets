...
class LinkMenuSet extends DataObject
{
    ...
    /**
     * Return the first menu set matching the given slug.
     *
    ...
    /**
     * Convert a space separated string (like this) to a camel case string (likeThis)
     *
     * By default, will replace all special characters with
     * spaces before uppercasing words and replacing spaces
     *
     * @author Benjamin Blake (sitelease.ca)
     *
